          ...
          <div className="p-8 rounded-lg bg-card/50 border border-border relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-4 text-muted-foreground">
              ...
              <p className="leading-relaxed">
                <span className="text-foreground font-mono">BuildGuide</span> generates a clear, ordered build guide based on your specific components—so you can focus on building, not searching.
              </p>
